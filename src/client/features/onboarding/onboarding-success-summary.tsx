  ...
  return (
    <div className="grid gap-4 border-b border-white/10 py-4 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-center">
      <div className="flex min-w-0 items-start gap-3">
        <span className="grid h-9 w-9 flex-none place-items-center rounded-full border border-white/15 bg-white/5 text-zinc-200">
          <AppIcon icon={icon} size={16} />
        </span>
        <span className="min-w-0">
          <span className="block font-mono text-[9px] font-semibold uppercase tracking-[0.18em] text-zinc-500">
            {label}
          </span>
      ...
      <span
        className={`w-fit rounded-full px-2.5 py-1 font-mono text-[8px] font-semibold uppercase tracking-[0.14em] ${
          active
            ? "bg-white text-black"
  ...
  return (
    <div className="grid animate-pulse gap-4 border-b border-white/10 py-4 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-center">
      <div className="flex items-start gap-3">
        <span className="h-9 w-9 flex-none rounded-full bg-white/10" />
