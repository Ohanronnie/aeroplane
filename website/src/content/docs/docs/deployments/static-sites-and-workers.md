...
Workers run background processes without public traffic. Use workers for queues, schedulers, job processors, event consumers, or any process that should stay alive but not listen behind Caddy.
